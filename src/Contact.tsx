    ...
    <div className="w-full flex flex-col justify-center lg:items-center" ref={container}>
      ...
      <div className="w-full flex flex-col lg:flex-row px-6 lg:ps-24 lg:pe-0 my-12 lg:my-20 items-center justify-center gap-x-32">
        <div className="flex flex-col">
          ...
          <input type="text" name="name" id="name" placeholder="Nom Complet" className="fade-right p-4 mt-8 border-[1px] border-gray-200 rounded-2xl" />
          <input type="email" name="email" id="email" placeholder="E-mail *" className="fade-right p-4 mt-4 border-[1px] border-gray-200 rounded-2xl" />
          <input type="phone" name="phone" id="phone" placeholder="Télephone *" className="fade-right p-4 mt-4 border-[1px] border-gray-200 rounded-2xl" />
          <textarea name="msg" id="msg" cols={30} rows={5} className="fade-right p-4 my-4 border-[1px] border-gray-200 rounded-2xl"></textarea>

          <button className="fade-left w-full bg-orangey py-3 uppercase text-white font-semibold rounded-xl">envoyez</button>
        </div>
