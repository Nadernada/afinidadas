...
const Coworking = () => {
  ...
  return (
    <div className="w-full flex flex-col lg:items-center mx-auto px-4 lg:px-0 2xl:max-w-[1440px]" ref={container}>
      ...
      <div className="offre lg:w-11/12 rounded-3xl lg:rounded-[60px] my-12 lg:my-32 mt-20 p-6 lg:p-20 pt-16 flex flex-col gap-x-10 bg-gradient">
        <div className="flex flex-col lg:flex-row gap-y-4 lg:gap-x-6">
          <div className="flex flex-col lg:w-2/3 gap-y-4">
            ...
            <div className="py-6 px-6 lg:px-12 flex flex-col lg:flex-row gap-y-4 lg:gap-x-6 border-2 border-primary rounded-3xl lg:rounded-[45px] items-center justify-between">
              ...
              <p className="fade-up-trigger text-[14px] lg:text-[16px]">Grâce à des espaces de travail dédiés, à Internet haute vitesse et à l’accès à des équipements tels que l’impression, les individus peuvent travailler efficacement sur leurs projets.</p>
            </div>
          </div>
          ...
          <div className="lg:hidden py-6 px-6 lg:px-12 flex flex-col lg:flex-row gap-y-4 lg:gap-x-6 bg-primary text-white rounded-3xl lg:rounded-[45px] items-center justify-between">
            ...
            <p className="fade-up-trigger text-[14px] lg:text-[16px]">Dans les espaces de coworking, où l'on peut se connecter et collaborer avec des professionnels de différentes industries.</p>
          </div>

          <div className="lg:w-1/3 py-6 px-6 lg:px-12  flex flex-col gap-y-4 lg:gap-y-6 border-2 border-primary rounded-3xl lg:rounded-[45px] items-center">
            ...
            <p className="fade-right text-[14px] lg:text-[16px]">Avec les frais d’adhésion tout compris, vous pouvez accéder à des espaces de travail professionnels, à des équipements et à des services de soutien sans les frais généraux de l’entretien de leur propre espace de bureau.</p>
          </div>
        </div>
        <div className="hidden lg:flex py-6 px-6 lg:px-12 mt-6 flex-col lg:flex-row gap-x-6 bg-primary text-white rounded-3xl lg:rounded-[45px] items-center justify-between">
          ...
          <div className="w-2/3 lg:w-[1px] bg-slate-500 h-[1px] lg:h-2/3" />
          <p className="text-[14px] lg:text-[16px]">Dans les espaces de coworking, où l'on peut se connecter et collaborer avec des professionnels de différentes industries.</p>
        </div>
      </div>
