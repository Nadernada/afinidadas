...
const Bureaux = () => {
  ...
  return (
    <div className="w-full 2xl:max-w-[1440px] flex flex-col mx-auto lg:items-center" ref={container}>
      ...
      <div className="bureaux-trigger lg:w-11/12 lg:rounded-[60px] mt-12 lg:mt-28 p-10 lg:p-16 pt-16 flex flex-col bg-gradient-to-b from-orangey/15 from-5% to-transparent to-70% ">
        <h3 className="font-bold text-[24px] lg:text-[48px] capitalize">Quels sont les avantages<br/> de louer avec nous?</h3>

        <div className="fade-up-trigger flex flex-col gap-y-6 my-8 lg:p-3">
      ...
      <div className="faq-trigger w-full flex flex-col relative bg-slate-100 px-10 lg:px-60 py-16 mb-12">
