...
import star from '../images/Soft Star.svg'
import leftHeroImage from '../images/leftHeroImage.png'
import rightSideDesk from '../images/rightSideDesk.png'
    ...
    <div className="w-full flex flex-col gap-y-16 2xl:w-[1440px]" ref={container}>
      ...
      <div className="flex flex-col items-center justify-center lg:-translate-x-24">
        ...
        <div className="flex flex-col items-start lg:translate-x-[50%] relative">
          <img src={star} alt="star" className="w-[20px] lg:w-[40px] h-[20px] lg:h-[40px] absolute right-4 lg:-right-6 -top-2 lg:-top-4" />
      ...
      <div className="flex flex-row justify-between relative">
        <img src={leftHeroImage} alt="espace coworking tanger" className="fade-left hidden lg:inline w-[600px]" />
        <img src={rightSideDesk} alt="espace coworking tanger" className="fade-right w-auto lg:h-[362px]"/>
        <Link to={'/contact'} className="fade-left w-[75%] lg:w-[600px] absolute -bottom-24 lg:-bottom-8 left-0 flex flex-row justify-evenly items-center bg-bluey rounded-e-full font-semibold capitalize text-white text-[18px] p-4">
          ...
          <img src={whiteStar} alt="star" className="w-[20px] h-[20px] lg:w-[28px] lg:h-[28px]" />
          <p className="">Reserver Maintenant</p>
          <img src={grayStar} alt="star" className="hidden lg:inline absolute top-0 left-[550px] w-[100px] h-[100px]" />
        </Link>
      </div>
    </div>
  )
